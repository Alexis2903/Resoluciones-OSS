...
public class MENU_ACTOR_Docente extends javax.swing.JFrame {

 
    
    public MENU_ACTOR_Docente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Bienvenido Docente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MENU_ACTOR_Docente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MENU_ACTOR_Docente().setVisible(true);
            }
        });
    }
