    ...
    private void bttnabrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnabrirActionPerformed
        // TODO add your handling code here:
         ...
         try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error al abrir el archivo PDF.", "Error", JOptionPane.ERROR_MESSAGE);
         }
         } else {
         JOptionPane.showMessageDialog(this, "Por favor, selecciona un pedido antes de intentar abrir el PDF.", "Advertencia", JOptionPane.WARNING_MESSAGE);
    }
