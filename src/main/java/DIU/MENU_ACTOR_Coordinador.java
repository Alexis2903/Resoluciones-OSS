...
public class MENU_ACTOR_Coordinador extends javax.swing.JFrame {


    
    public MENU_ACTOR_Coordinador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Bienvenido Coordinador");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MENU_ACTOR_Coordinador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MENU_ACTOR_Coordinador().setVisible(true);
            }
        });
    }
